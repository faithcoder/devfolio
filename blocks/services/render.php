  ...
  <div class="devfolio-container">
    ...
    <div class="devfolio-services-grid">
      ...
      <div class="devfolio-service-card devfolio-glass devfolio-anim">
        <div class="devfolio-service-icon"><?php echo devfolio_render_icon( $service['iconImage'] ?? '', $service['icon'] ?? $default_service_icon, $service['title'] ?? 'Icon' ); ?></div>
