...
$contact_label = devfolio_get_block_attr( $args, 'label', 'Let us talk support' );
$contact_title = devfolio_get_block_attr( $args, 'titleText', 'Need WordPress Support Help?' );
  ...
  <div class="devfolio-container">
    <div class="devfolio-contact-box devfolio-glass devfolio-anim">
      <div class="devfolio-content">
        ...
        <a href="<?php echo esc_attr( 'mailto:' . antispambot( sanitize_email( $contact_email ) ) ); ?>" class="devfolio-btn devfolio-btn-glow">
