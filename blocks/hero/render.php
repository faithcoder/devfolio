...
$hero_label       = devfolio_get_block_attr( $args, 'heroLabel', 'Software Engineer • Full Stack Developer' );
$hero_before      = devfolio_get_block_attr( $args, 'heroTitleBefore', 'I build scalable' );
$hero_highlight   = devfolio_get_block_attr( $args, 'heroTitleHighlight', 'web and mobile applications' );
$hero_after       = devfolio_get_block_attr( $args, 'heroTitleAfter', 'for a smarter world.' );
$hero_subtitle    = devfolio_get_block_attr( $args, 'heroSubtitle', 'Software Engineer with expertise in Laravel, React, Next.js, and Mobile App Development. Dedicated to building innovative solutions that make the world easier and faster.' );
$hero_cta_1_text  = devfolio_get_block_attr( $args, 'primaryText', 'Contact Me' );
$hero_cta_1_url   = devfolio_get_block_attr( $args, 'primaryUrl', '#' . devfolio_get_section_id( 'contact' ) );
...
$social_profiles = devfolio_get_block_array_attr(
	$args,
	'socialProfiles',
	array(
