...
$linkedin_url     = devfolio_get_theme_mod_value( 'devfolio_social_linkedin', 'https://linkedin.com' );
$github_url       = devfolio_get_theme_mod_value( 'devfolio_social_github', 'https://github.com' );
$wordpress_url    = devfolio_get_theme_mod_value( 'devfolio_social_wordpress', 'https://wordpress.org' );
      ...
      <div class="devfolio-hero-text">
        ...
        <div class="devfolio-hero-actions devfolio-anim">
          ...
          <div class="devfolio-social-icons">
            <a href="<?php echo esc_url( $linkedin_url ); ?>" target="_blank" class="devfolio-social-icon devfolio-glass" aria-label="LinkedIn">
            ...
            <a href="<?php echo esc_url( $github_url ); ?>" target="_blank" class="devfolio-social-icon devfolio-glass" aria-label="GitHub">
            ...
            <a href="<?php echo esc_url( $wordpress_url ); ?>" target="_blank" class="devfolio-social-icon devfolio-glass" aria-label="WordPress">
