...
$default_experience = array(
	...
	array( 'title' => 'SoftTech-IT Institute', 'meta' => 'Associate Mentor, WordPress Theme Development | Mar 2021 - Oct 2023 | Part Time', 'desc' => 'Guided multiple batches through HTML-to-WordPress conversion, custom post types, taxonomies, and established theme and builder workflows.' ),
...
$experience_label = devfolio_get_theme_mod_value( 'devfolio_experience_label', 'Experience' );
$experience_title = devfolio_get_theme_mod_value( 'devfolio_experience_title', 'Support & Technical Experience' );
$experience_desc  = devfolio_get_theme_mod_value( 'devfolio_experience_desc', '' );
?>
<!-- Experience -->
