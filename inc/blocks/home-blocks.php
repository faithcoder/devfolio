...
function devfolio_get_home_block_specs() {
	return array(
		...
		'plugin-details' => array(
			'title'        => __( 'Plugin Details Section', 'devfolio' ),
			'description'  => __( 'Funnel-style plugin detail page with features and download link.', 'devfolio' ),
			'default_home' => false,
			'keywords'     => array( __( 'plugin', 'devfolio' ), __( 'details', 'devfolio' ), __( 'download', 'devfolio' ), __( 'funnel', 'devfolio' ) ),
			'attributes'   => array(
				'label'      => array( 'type' => 'string', 'default' => '' ),
				'titleText'  => array( 'type' => 'string', 'default' => '' ),
				'desc'       => array( 'type' => 'string', 'default' => '' ),
