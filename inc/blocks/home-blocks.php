...
function devfolio_get_home_block_specs() {
	return array(
		...
		'portfolio'    => array(
			...
			'description' => __( 'Clickable portfolio cards that link to internal case-study pages.', 'devfolio' ),
			'attributes'  => array(
				'label' => array( 'type' => 'string', 'default' => '' ),
				'titleText' => array( 'type' => 'string', 'default' => '' ),
				'desc' => array( 'type' => 'string', 'default' => '' ),
		...
		'project-details' => array(
			'title'        => __( 'Project Details Section', 'devfolio' ),
			'description'  => __( 'Case-study layout for individual portfolio project pages.', 'devfolio' ),
			'default_home' => false,
			'keywords'     => array( __( 'project', 'devfolio' ), __( 'portfolio', 'devfolio' ), __( 'case study', 'devfolio' ) ),
			'attributes'   => array(
				'label'            => array( 'type' => 'string', 'default' => '' ),
				'titleText'        => array( 'type' => 'string', 'default' => '' ),
				...
				'challenge'        => array( 'type' => 'string', 'default' => '' ),
				'approach'         => array( 'type' => 'string', 'default' => '' ),
				'screenshots'      => array( 'type' => 'array', 'default' => array() ),
				'technologies'     => array( 'type' => 'string', 'default' => '' ),
				'features'         => array( 'type' => 'string', 'default' => '' ),
				'result'           => array( 'type' => 'string', 'default' => '' ),
				'liveUrl'          => array( 'type' => 'string', 'default' => '' ),
				'portfolioUrl'     => array( 'type' => 'string', 'default' => '' ),
				'liveButtonText'   => array( 'type' => 'string', 'default' => '' ),
				'backButtonText'   => array( 'type' => 'string', 'default' => '' ),
			),
		),
		'plugin-hero' => array(
			'title'        => __( 'Plugin Hero Section', 'devfolio' ),
			'description'  => __( 'Product hero with headline, screenshot, download action, and benefit strip.', 'devfolio' ),
			'default_home' => false,
			'keywords'     => array( __( 'plugin', 'devfolio' ), __( 'product', 'devfolio' ), __( 'hero', 'devfolio' ), __( 'download', 'devfolio' ) ),
			'attributes'   => array(
				...
				'downloads'   => array( 'type' => 'string', 'default' => '' ),
				'image'       => array( 'type' => 'string', 'default' => '' ),
				'iconImage'   => array( 'type' => 'string', 'default' => '' ),
				'benefitItems'=> array( 'type' => 'array', 'default' => array() ),
			),
		),
		'plugin-feature' => array(
			'title'        => __( 'Plugin Feature Section', 'devfolio' ),
			'description'  => __( 'Two-column feature section with bold copy, checklist, and screenshot.', 'devfolio' ),
			'default_home' => false,
			'keywords'     => array( __( 'plugin', 'devfolio' ), __( 'feature', 'devfolio' ), __( 'screenshot', 'devfolio' ), __( 'checklist', 'devfolio' ) ),
			'attributes'   => array(
				'titleText'    => array( 'type' => 'string', 'default' => '' ),
				'image'        => array( 'type' => 'string', 'default' => '' ),
				'featureItems' => array( 'type' => 'array', 'default' => array() ),
			),
		),
			'services'     => array(
